...
if __name__ == "__main__":
    ...
    parser.add_argument("--csv_path", help="csv_path", default="/content/drive/My Drive/CustomTrain-MobileNetV2/config_files/data.csv")
    parser.add_argument("--data_config_path",help="data_config_path",default="/content/drive/My Drive/CustomTrain-MobileNetV2/config_files/data_config.yaml")
    parser.add_argument("--training_config_path",help="training_config_path",default="/content/drive/My Drive/CustomTrain-MobileNetV2/config_files/training_config.yaml")
    ...
    train_from_csv(csv_path=csv_path,data_config_path=data_config_path,training_config_path=training_config_path)
