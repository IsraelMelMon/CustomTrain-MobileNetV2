...
#default='/Users/concertam/Documents/classes/')#default='/content/drive/My Drive/CustomTrain-MobileNetV2/classes/')
...
for x in classes: 
    ...
    for i in names_clean:
        if x in i:
            new_set.append(1)
            new_names_clean.append(x+"/"+i)
            #print(1)
        else:
            new_set.append(0)
            #print(0) 
    new_column.append(new_set)
#print(new_names_clean)
# insert csv columns headers
new_column.insert(0, new_names_clean)
classes2 = classes
